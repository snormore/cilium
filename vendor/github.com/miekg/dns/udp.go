...
type SessionUDP interface {
	...
	// Must be called whwnever the request needs to be discarded.
	Discard()
	...
	// address the request came from.  On return SessionUDP is
	// automatically discarded, so Discard() must not be called
	// after this!
